...
def collecting(target):
    ...
    for i in range(10):
        ...
        data = [gyroskop_xout, gyroskop_yout, gyroskop_zout, beschleunigung_xout, beschleunigung_yout, beschleunigung_zout, i]
        dataset.append(data)
        time.sleep(0.1)
...
while(choose):
    ...
    if answer == '1':
        ...
        df_temp = pd.DataFrame(np.array(data), columns = ["g_x", "g_y", "g_z", "a_x", "a_y", "a_z", "step","target"])
